...
public class CollectionRootImpl extends MinimalEObjectImpl.Container implements CollectionRoot {
	...
	public EList<Collection> getCollection() {
		if (collection == null) {
			collection = new EObjectContainmentEList<Collection>(Collection.class, this,
					CollectionPackage.COLLECTION_ROOT__COLLECTION);
		}
		return collection;
	}
	...
	public EList<Category> getCategories() {
		if (categories == null) {
			categories = new EObjectContainmentEList<Category>(Category.class, this,
					CollectionPackage.COLLECTION_ROOT__CATEGORIES);
		}
		return categories;
	}
