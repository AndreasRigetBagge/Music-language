 ...
 *   <li>{@link playlist.impl.PlaylistImpl#getQuery <em>Query</em>}</li>
 *   <li>{@link playlist.impl.PlaylistImpl#getTrack <em>Track</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaylistImpl extends MinimalEObjectImpl.Container implements Playlist {
		...
		if (configuration != null && configuration.eIsProxy()) {
			...
			if (configuration != oldConfiguration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PlaylistPackage.PLAYLIST__CONFIGURATION, oldConfiguration, configuration));
			}
		}
	...
	public void setConfiguration(Configuration newConfiguration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlaylistPackage.PLAYLIST__CONFIGURATION, oldConfiguration, configuration));
	}
	...
	public EList<Query> getQuery() {
		if (query == null) {
			query = new EObjectResolvingEList<Query>(Query.class, this, PlaylistPackage.PLAYLIST__QUERY);
		}
		return query;
	}
	...
	public EList<Track> getTrack() {
		if (track == null) {
			track = new EObjectResolvingEList<Track>(Track.class, this, PlaylistPackage.PLAYLIST__TRACK);
		}
		return track;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PlaylistPackage.PLAYLIST__QUERY:
				return getQuery();
			case PlaylistPackage.PLAYLIST__TRACK:
				return getTrack();
		}
