...
import muslan.queue.QueueFactory;
...
public class QueuePackageImpl extends EPackageImpl implements QueuePackage {
	 ...
	 * @see muslan.queue.QueuePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static QueuePackage init() {
		if (isInited)
			return (QueuePackage) EPackage.Registry.INSTANCE.getEPackage(QueuePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredQueuePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		QueuePackageImpl theQueuePackage = registeredQueuePackage instanceof QueuePackageImpl
				? (QueuePackageImpl) registeredQueuePackage
				: new QueuePackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getQueue_Tracks(), theCollectionPackage.getTrack(), null, "tracks", null, 0, -1, Queue.class,
