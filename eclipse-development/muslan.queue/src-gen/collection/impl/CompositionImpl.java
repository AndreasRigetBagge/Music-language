...
public class CompositionImpl extends CategorizedElementImpl implements Composition {
	...
	public EList<Track> getTracks() {
		if (tracks == null) {
			tracks = new EObjectWithInverseResolvingEList.ManyInverse<Track>(Track.class, this,
					CollectionPackage.COMPOSITION__TRACKS, CollectionPackage.TRACK__COMPOSITIONS);
		}
		return tracks;
	}
