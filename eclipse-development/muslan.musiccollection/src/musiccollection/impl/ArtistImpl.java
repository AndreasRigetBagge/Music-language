 ...
 * </p>
 * <ul>
 *   <li>{@link musiccollection.impl.ArtistImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtistImpl extends MinimalEObjectImpl.Container implements Artist {
	...
	protected EClass eStaticClass() {
		return MusiccollectionPackage.Literals.ARTIST;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MusiccollectionPackage.ARTIST__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MusiccollectionPackage.ARTIST__NAME:
				return getName();
		}
