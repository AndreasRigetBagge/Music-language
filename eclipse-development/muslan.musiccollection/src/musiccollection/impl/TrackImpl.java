 ...
 * </p>
 * <ul>
 *   <li>{@link musiccollection.impl.TrackImpl#getCompositions <em>Compositions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrackImpl extends CategorizedElementImpl implements Track {
	...
	protected EClass eStaticClass() {
		return MusiccollectionPackage.Literals.TRACK;
	}
	...
	public EList<Composition> getCompositions() {
		if (compositions == null) {
			compositions = new EObjectWithInverseResolvingEList.ManyInverse<Composition>(Composition.class, this, MusiccollectionPackage.TRACK__COMPOSITIONS, MusiccollectionPackage.COMPOSITION__TRACKS);
		}
		return compositions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MusiccollectionPackage.TRACK__COMPOSITIONS:
