 ...
 * </p>
 * <ul>
 *   <li>{@link musiccollection.impl.AlbumImpl#getTracks <em>Tracks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlbumImpl extends CategorizedElementImpl implements Album {
	...
	protected EClass eStaticClass() {
		return MusiccollectionPackage.Literals.ALBUM;
	}
	...
	public EList<Track> getTracks() {
		if (tracks == null) {
			tracks = new EObjectResolvingEList<Track>(Track.class, this, MusiccollectionPackage.ALBUM__TRACKS);
		}
		return tracks;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MusiccollectionPackage.ALBUM__TRACKS:
				return getTracks();
		}
