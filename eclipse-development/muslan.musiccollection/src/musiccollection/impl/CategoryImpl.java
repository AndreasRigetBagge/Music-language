 ...
 * </p>
 * <ul>
 *   <li>{@link musiccollection.impl.CategoryImpl#getCategoryType <em>Category Type</em>}</li>
 *   <li>{@link musiccollection.impl.CategoryImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	protected EClass eStaticClass() {
		return MusiccollectionPackage.Literals.CATEGORY;
	}
	...
	public void setCategoryType(CategoryType newCategoryType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MusiccollectionPackage.CATEGORY__CATEGORY_TYPE, oldCategoryType, categoryType));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MusiccollectionPackage.CATEGORY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MusiccollectionPackage.CATEGORY__CATEGORY_TYPE:
				return getCategoryType();
			case MusiccollectionPackage.CATEGORY__VALUE:
				return getValue();
		}
