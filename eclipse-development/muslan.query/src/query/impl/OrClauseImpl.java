...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Or Clause</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link query.impl.OrClauseImpl#getFilterclause <em>Filterclause</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrClauseImpl extends FilterClauseImpl implements OrClause {
	/**
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.OR_CLAUSE;
	}
	...
	public EList<FilterClause> getFilterclause() {
		if (filterclause == null) {
			filterclause = new EObjectContainmentEList<FilterClause>(FilterClause.class, this, QueryPackage.OR_CLAUSE__FILTERCLAUSE);
		}
		return filterclause;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QueryPackage.OR_CLAUSE__FILTERCLAUSE:
