...
public class CollectionPackageImpl extends EPackageImpl implements CollectionPackage {
	 ...
	 */
	@Override
	public EReference getCollection_Item() {
	...
	public void createPackageContents() {
		...
		createEReference(collectionEClass, COLLECTION__ITEM);
	...
	public void initializePackageContents() {
		...
		trackEClass.getESuperTypes().add(this.getItem());

		// Initialize classes, features, and operations; add parameters
		initEClass(collectionEClass, Collection.class, "Collection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCollection_Item(), this.getItem(), null, "item", null, 0, -1, Collection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
