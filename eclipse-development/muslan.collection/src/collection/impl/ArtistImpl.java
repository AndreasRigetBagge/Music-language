 ...
 * </p>
 * <ul>
 *   <li>{@link collection.impl.ArtistImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtistImpl extends MinimalEObjectImpl.Container implements Artist {
	...
	protected EClass eStaticClass() {
		return CollectionPackage.Literals.ARTIST;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectionPackage.ARTIST__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CollectionPackage.ARTIST__NAME:
				return getName();
		}
