...
public class CollectionImpl extends MinimalEObjectImpl.Container implements Collection {
	...
	public EList<CategorizedElement> getCategorizedelements() {
		if (categorizedelements == null) {
			categorizedelements = new EObjectContainmentEList<CategorizedElement>(CategorizedElement.class, this, CollectionPackage.COLLECTION__CATEGORIZEDELEMENTS);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectionPackage.COLLECTION__NAME, oldName, name));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CollectionPackage.COLLECTION__CATEGORIZEDELEMENTS:
				...
				getCategorizedelements().addAll((java.util.Collection<? extends CategorizedElement>)newValue);
				return;
			case CollectionPackage.COLLECTION__NAME:
