...
public class TrackImpl extends CategorizedElementImpl implements Track {
	...
	public EList<Composition> getCompositions() {
		if (compositions == null) {
			compositions = new EObjectWithInverseResolvingEList.ManyInverse<Composition>(Composition.class, this, CollectionPackage.TRACK__COMPOSITIONS, CollectionPackage.COMPOSITION__TRACKS);
		}
		return compositions;
	}
