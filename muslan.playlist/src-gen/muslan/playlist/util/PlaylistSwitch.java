...
public class PlaylistSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PlaylistPackage.QUERY: {
			...
			if (result == null)
				result = casePlaylist(query);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case PlaylistPackage.TRACK_LIST: {
			TrackList trackList = (TrackList) theEObject;
			T result = caseTrackList(trackList);
			if (result == null)
				result = casePlaylist(trackList);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Track List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Track List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTrackList(TrackList object) {
		return null;
	}
